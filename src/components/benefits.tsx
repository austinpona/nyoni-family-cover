    ...
    <section id="benefits" className="paper-grain bg-cream pb-20 sm:pb-28">
      <div className="container-shell">
        <div className="relative min-h-[34rem] overflow-hidden rounded-xl bg-charcoal shadow-[0_30px_80px_-55px_rgba(41,40,37,.65)]">
          <Image src="/images/nyoni-benefits-real.webp" alt="A cow, two 50kg maize meal bags, firewood and a white bakkie representing Nyoni basic benefits" fill sizes="(max-width:1280px) 100vw, 1248px" className="object-cover" />
